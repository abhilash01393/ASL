...
model = load_model("weights-30.h5")
#mlb = pickle.loads(open("lb.pickle", "rb").read())
...
earlyStopImprovement = EarlyStopping(monitor='loss', min_delta=0, patience=4, verbose=1, mode='auto')
modelCheckPoint = ModelCheckpoint("./models/weights-{epoch:02d}.h5", monitor='val_loss', verbose=0, save_best_only=False, save_weights_only=False, mode='auto', period=1)
...
H = model.fit_generator(
	...
	epochs=5, verbose=1, callbacks=[tensorboard,modelCheckPoint,earlyStopImprovement,log])
